...
<div class="min-h-screen bg-gray-50 flex flex-col">
	...
	<div class="bg-white border-b border-gray-200 sticky top-0 z-40">
		...
		<div class="max-w-2xl mx-auto px-4 flex items-center justify-between gap-4 py-3">
			...
			<a href="/stores/{data.store.id}/inventory/{data.session.id}/complete"
				class="press inline-flex items-center gap-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-medium px-3 py-1.5 rounded-lg transition-colors whitespace-nowrap">
				Review
